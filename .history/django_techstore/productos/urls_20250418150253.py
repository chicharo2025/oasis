...
from .views import index, detalle_producto,catalogo,categorias,agregar_producto, eliminar_producto,restar_producto,limpiar_carrito
...
urlpatterns = [
    ...
    path('carrito/', views.tienda, name="carrito")  # O cualquier otra vista relacionada con el carrito
