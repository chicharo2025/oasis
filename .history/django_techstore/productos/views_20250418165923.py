...
def productos_por_categoria(request, categoria_id):
    ...
    productos = Producto.objects.filter(categoria=categoria)  # Filtra productos por la categoría
    return render(request, 'categori.html', {'categoria': categoria, 'productos': productos})
