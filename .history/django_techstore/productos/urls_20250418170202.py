...
urlpatterns = [
    ...
    path('categorias/', categorias, name='categorias_lista'),  # ✅ esta muestra TODAS las categorías
    path('categorias/<int:categoria_id>/', productos_por_categoria, name='productos_por_categoria'),
