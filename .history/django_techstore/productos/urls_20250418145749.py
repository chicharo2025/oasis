...
urlpatterns = [
    ...
    path('carrito/', carrito, name='catalogo'),
    path('agregar/<int:producto_id>/', views.agregar_producto, name="AgregarProducto"),
    path('eliminar/<int:producto_id>/', views.eliminar_producto, name="EliminarProducto"),
    path('restar/<int:producto_id>/', views.restar_producto, name="RestarProducto"),
    path('limpiar/', views.limpiar_carrito, name="LimpiarCarrito"),
